...
def validate_color_format(color_value: str) -> bool:
    ...
    # Check RGBA format
    rgba_match = re.match(r'rgba\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*(0|1|0?\.\d+)\s*\)$', color_value)
    if rgba_match:
    ...
    # Check HSLA format
    hsla_match = re.match(r'hsla\s*\(\s*(\d+)\s*,\s*(\d+)%\s*,\s*(\d+)%\s*,\s*(0|1|0?\.\d+)\s*\)$', color_value)
    if hsla_match:
    ...
    named_colors = {
        ...
        'purple', 'red', 'silver', 'teal', 'white', 'yellow', 'orange', 'pink', 'turquoise', 'violet',
        'wheat', 'tan', 'plum', 'chocolate', 'salmon', 'coral', 'firebrick', 'indigo', 'gold', 'tomato',
        'cyan', 'crimson', 'darkblue', 'darkcyan', 'darkgoldenrod', 'darkgray', 'darkgreen', 'darkkhaki',
        'darkmagenta', 'darkolivegreen', 'darkorange', 'darkorchid', 'darkred', 'darksalmon', 'darkseagreen',
        'darkslateblue', 'darkslategray', 'darkturquoise', 'darkviolet', 'deeppink', 'deepskyblue', 'dimgray',
        'dodgerblue', 'forestgreen', 'goldenrod', 'gray', 'indianred', 'indigo', 'lavenderblush', 'lawngreen',
        'lemonchiffon', 'lightcoral', 'lightcyan', 'lightgray', 'lightgreen', 'lightpink', 'magenta',
        'mediumvioletred', 'olivedrab', 'orangered', 'orchid', 'palevioletred', 'peru', 'plum', 'rosybrown',
        'royalblue', 'saddlebrown', 'salmon', 'sandybrown', 'seagreen', 'sienna', 'skyblue', 'slateblue',
        'slategray', 'springgreen', 'steelblue', 'violet', 'yellowgreen', 'rebeccapurple'
    }
